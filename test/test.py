import sys
from practica_nltk.src import Tagger, RegexChunker
...
# Entrenar tagger
tagger = Tagger.Tagger('trigram', sents)
...
regex_chunker = RegexChunker(grammar, "hdm")
regex_chunker.train_tagger(train)

# Guardar iob tags
write_iob_tags(IOB_INPUT_FILE, corpus, regex_chunker)
...
def test_consecutive_np_chunker(train, tagged_sentence):
	...
	chunker = ConsecutiveNPChunker(tagged_sentence) 
	chunker.parse(tagged_sentence)
